      ...
      },
      {
        $group: {
          ...
          'wallet:sum:fromAmountUsd': {
            $sum: {
              $cond: [{ $regex: { input: '$userAgent', regex: /^Wallet/i } }, '$fromAmountUsd', 0]
            }
          },
          'wallet:sum:toAmountUsd': {
            $sum: {
              $cond: [{ $regex: { input: '$userAgent', regex: /^Wallet/i } }, '$toAmountUsd', 0]
            }
          },
          'wallet:count': {
            $sum: {
              $cond: [{ $regex: { input: '$userAgent', regex: /^Wallet/i } }, 1, 0]
            }
          },
